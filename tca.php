...
$TCA["tx_t3m_categories"] = Array (
	...
	"interface" => Array (
		"showRecordFieldList" => "sys_language_uid,l18n_parent,l18n_diffsource,hidden,name,description,calculated_receivers,subcategories"
	),
	...
	"types" => Array (
		"0" => Array("showitem" => "sys_language_uid;;;;1-1-1, l18n_parent, l18n_diffsource, hidden;;1, name, description, calculated_receivers, subcategories")
	),
	"palettes" => Array (
		"1" => Array("showitem" => "")
	)
